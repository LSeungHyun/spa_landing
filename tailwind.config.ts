    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          'accent-purple': 'var(--brand-accent-purple)',
          'accent-cyan': 'var(--brand-accent-cyan)',
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
